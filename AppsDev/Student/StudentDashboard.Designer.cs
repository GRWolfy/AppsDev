...
namespace AppsDev.Student
{
   partial class StudentDashboard
   {
      ...
      private void InitializeComponent()
      {
         ...
         // linklViewpayments
         // 
         this.linklViewpayments.AutoSize = true;
         this.linklViewpayments.Location = new System.Drawing.Point(239, 358);
         this.linklViewpayments.Name = "linklViewpayments";
         this.linklViewpayments.Size = new System.Drawing.Size(79, 13);
         this.linklViewpayments.TabIndex = 19;
         this.linklViewpayments.TabStop = true;
         this.linklViewpayments.Text = "View Payments";
         // 
         // label6
         // 
